...
import type { EditorPermissions } from "@/features/editor/hooks/useEditorPermissions";
import { useElementCreator } from "@/features/editor/hooks/element/useElementCreator";
import {
  showErrorToast,
  showSuccessToast,
  PERMISSION_ERRORS,
