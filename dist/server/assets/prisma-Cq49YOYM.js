...
class ApiClient {
  ...
  async execute(method, url, data, options = {}) {
  ...
  async delete(url, options) {
    await this.execute("DELETE", url, void 0, options);
    return true;
  }
...
const componentMap = {
  // Inline / Leaf
  Text: () => import("./index-CGf_Qej1.js").then(
    (m) => m.BaseComponent
  ),
  Span: () => import("./index-CGf_Qej1.js").then(
    (m) => m.BaseComponent
  ),
  Heading: () => import("./index-CGf_Qej1.js").then(
    (m) => m.HeadingComponent
  ),
  Label: () => import("./index-CGf_Qej1.js").then(
    (m) => m.BaseComponent
  ),
  Blockquote: () => import("./index-CGf_Qej1.js").then(
    (m) => m.BlockquoteComponent
  ),
  Code: () => import("./index-CGf_Qej1.js").then(
    (m) => m.CodeComponent
  ),
  Separator: () => import("./index-CGf_Qej1.js").then(
    (m) => m.SeparatorComponent
  ),
  Icon: () => import("./index-CGf_Qej1.js").then(
    (m) => m.IconComponent
  ),
  // Media
  Image: () => import("./index-CGf_Qej1.js").then(
    (m) => m.ImageComponent
  ),
  Video: () => import("./index-CGf_Qej1.js").then(
    (m) => m.VideoComponent
  ),
  Audio: () => import("./index-CGf_Qej1.js").then(
    (m) => m.AudioComponent
  ),
  IFrame: () => import("./index-CGf_Qej1.js").then(
    (m) => m.IFrameComponent
  ),
  // Interactive
  Button: () => import("./index-CGf_Qej1.js").then(
    (m) => m.ButtonComponent
  ),
  Link: () => import("./index-CGf_Qej1.js").then(
    (m) => m.BaseComponent
  ),
  // Form
  Input: () => import("./index-CGf_Qej1.js").then(
    (m) => m.InputComponent
  ),
  Textarea: () => import("./index-CGf_Qej1.js").then(
    (m) => m.TextareaComponent
  ),
  Checkbox: () => import("./index-CGf_Qej1.js").then(
    (m) => m.CheckboxComponent
  ),
  Radio: () => import("./index-CGf_Qej1.js").then(
    (m) => m.RadioComponent
  ),
  Select: () => import("./index-CGf_Qej1.js").then(
    (m) => m.SelectComponent
  ),
  Form: () => import("./index-CGf_Qej1.js").then(
    (m) => m.FormComponent
  ),
  Progress: () => import("./index-CGf_Qej1.js").then(
    (m) => m.ProgressComponent
  ),
  // Table
  Table: () => import("./index-CGf_Qej1.js").then(
    (m) => m.TableComponent
  ),
  // Container / Layout
  Frame: () => import("./index-CGf_Qej1.js").then(
    (m) => m.FrameComponent
  ),
  Section: () => import("./index-CGf_Qej1.js").then(
    (m) => m.SectionComponent
  ),
  Nav: () => import("./index-CGf_Qej1.js").then(
    (m) => m.SemanticContainerComponent
  ),
  Header: () => import("./index-CGf_Qej1.js").then(
    (m) => m.SemanticContainerComponent
  ),
  Footer: () => import("./index-CGf_Qej1.js").then(
    (m) => m.SemanticContainerComponent
  ),
  Article: () => import("./index-CGf_Qej1.js").then(
    (m) => m.SemanticContainerComponent
  ),
  Aside: () => import("./index-CGf_Qej1.js").then(
    (m) => m.SemanticContainerComponent
  ),
  // Carousel
  Carousel: () => import("./index-CGf_Qej1.js").then(
    (m) => m.CarouselComponent
  ),
  // List
  List: () => import("./index-CGf_Qej1.js").then(
    (m) => m.ListComponent
  ),
  // CMS
  CMSContentList: () => import("./index-CGf_Qej1.js").then(
    (m) => m.CMSContentListComponent
  ),
  CMSContentItem: () => import("./index-CGf_Qej1.js").then(
    (m) => m.CMSContentItemComponent
  ),
  CMSContentGrid: () => import("./index-CGf_Qej1.js").then(
...
const projectService = {
  ...
  getFonts: async () => {
    const apiKey = "AIzaSyBbgdd4D8zU_QThCca2bkw0lnXG3JPka0k";
...
const createProject = createServerFn({
  method: "POST"
}).inputValidator((data) => CreateProjectSchema.parse(data)).handler(createSsrRpc("6a0643ddc1f5eef517e083f878a467ea542d48a4b3071275fda2bb775bf45ee7"));
...
export {
  ...
  Tabs as T,
  URLBuilder as U,
  useUserProjects as V,
  onMutationError as W,
  QUERY_CONFIG as X,
  Empty as Y,
  EmptyHeader as Z,
  EmptyMedia as _,
  apiClient as a,
  DialogClose as a$,
  EmptyDescription as a0,
  EmptyContent as a1,
  marketplaceItemSchema as a2,
  Form as a3,
  FormField as a4,
  FormItem as a5,
  FormLabel as a6,
  FormControl as a7,
  FormMessage as a8,
  FormDescription as a9,
  getErrorMessage as aA,
  elementEventWorkflowKeys as aB,
  useElementEventWorkflowStore as aC,
  getComponentFactory as aD,
  ImagesArraySchema as aE,
  ImageFileSchema as aF,
  ImageUploadResponseSchema as aG,
  useImageStore as aH,
  ImageDragDataSchema as aI,
  getToken as aJ,
  CreateEventWorkflowSchema as aK,
  useWorkflowCanvas as aL,
  ANIMATION_DURATIONS as aM,
  NodeType as aN,
  getNodeTypeColor as aO,
  WORKFLOW_EVENT_TYPES as aP,
  validateCreateConnection as aQ,
  getFirstError as aR,
  CreateElementEventWorkflowSchema as aS,
  validateDisconnectConnection as aT,
  mapWorkflowNodeToReactFlow as aU,
  CONNECTION_CONFIG as aV,
  VALIDATION_ERRORS as aW,
  createReactFlowNode as aX,
  NODE_TYPE_LABELS as aY,
  validateWorkflowCanvas as aZ,
  NodePalette as a_,
  useDeleteProject as aa,
  usePublishProject as ab,
  useProjectStore as ac,
  showSuccessToast as ad,
  useMouseStore as ae,
  DialogTrigger as af,
  useEventModeStore as ag,
  usePageStore as ah,
  TooltipProvider as ai,
  Tooltip as aj,
  TooltipTrigger as ak,
  TooltipContent as al,
  useElementCommentStore as am,
  onMutationSuccess as an,
  useProjectPages as ao,
  useProject as ap,
  showErrorToast as aq,
  customComps as ar,
  PERMISSION_ERRORS as as,
  ElementStore as at,
  ElementTreeHelper as au,
  useElementStore as av,
  elementHolders as aw,
  useSidebar as ax,
  useSelectionStore as ay,
  SelectionStore as az,
  computeTailwindFromStyles as b,
  createSsrRpc as c,
  prisma as d,
  Permission as e,
  Badge as f,
  ...
  SidebarHeader as u,
  SidebarMenu as v,
  SidebarMenuItem as w,
  SidebarMenuButton as x,
  SidebarRail as y,
  SidebarContent as z
};
