...
import "clsx";
import { d as Badge, B as Button, h as cn, L as Label, U as Empty, V as EmptyHeader, W as EmptyMedia, X as EmptyTitle, Y as EmptyDescription, Z as EmptyContent, I as Input } from "./prisma-BUnO9f9X.js";
...
import { a as useDownloadMarketplaceItem, b as useIncrementLikes, c as useCategories, u as useMarketplaceItems } from "./useMarketplace-D0GCoGnq.js";
import { u as useInView } from "./useInView-BXOOtJcA.js";
import { C as Card, a as CardContent, e as CardFooter } from "./card-D42cGFKZ.js";
...
function MarketplaceCard({ item }) {
  ...
  return /* @__PURE__ */ jsx(Link, { to: "/marketplace/$id", params: { id: item.id }, children: /* @__PURE__ */ jsxs(Card, { className: "group overflow-hidden hover:shadow-lg transition-all duration-300 border-border bg-card p-0 h-full flex flex-col cursor-pointer", children: [
